...
const PRIVATE_KEY = process.env.ALIPAY_PRIVATE_KEY || toPem(RAW_PRIVATE_KEY, 'private')
const PUBLIC_KEY = process.env.ALIPAY_PUBLIC_KEY || toPem(RAW_PUBLIC_KEY, 'public')
